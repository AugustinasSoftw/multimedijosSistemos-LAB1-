...
The player was successfully tested on the following browsers:

- **Google Chrome**: Version 122.0.6261.112
- **Mozilla Firefox**: Version 123.0.1

**Note on "Big Bunny" Stream:** The primary Big Bunny stream (`https://video-dev.github.io/...`) failed to load on `localhost` due to strict CORS policy blocking the XMLHttpRequest. As per the assignment instructions, I used the provided BipBop fallback stream (`https://d2zihajmogu5jn.cloudfront.net/...`), which works perfectly.
